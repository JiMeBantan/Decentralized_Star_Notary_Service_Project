...
contract StarNotary is ERC721 {
    ...
    //string constant name = "StarNotaryToken";
    //string constant symbol = "SNT";
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        address adrs1 = ownerOf(_tokenId1);
        address adrs2 = ownerOf(_tokenId2);
        //4. Use _transferFrom function to exchange the tokens.
        if ( msg.sender == adrs1 ) {
            _transfer(adrs1, adrs2, _tokenId1);
            _transfer(adrs2, adrs1, _tokenId2);
        }
        if ( msg.sender == adrs2 ) {
            _transfer(adrs2, adrs1, _tokenId2);
            _transfer(adrs1, adrs2, _tokenId1);
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(msg.sender == ownerOf(_tokenId),"The sender is not the owner of the token");
